      ...
      <div class="container-fluid">
         ...
         <div id="bs-example-navbar-collapse-1"  class="collapse navbar-collapse hidden-lg hidden-md hidden-sm">
               <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="tfwsFee.php">TFWS Semester Fee</a></li>
            ...
            <div class=" col-md-10 col-md-offset-2 main">
             ...
             <button type="button" class="btn btn-group-lg" data-toggle="modal" data-target=".bs-modal-lg" >Serach</button>
			   ...
			   error_reporting(0);
				...
				$semester = $_POST['sem']; 
				$batch = $_POST['batch'];
				  $qryy = "SELECT * FROM `tfwsfee` WHERE `sem` = '".$semester."' AND `batch` = '".$batch."'"; 
         ...
         <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <form class="form-horizontal" id="tfwsedit" name="tfwsedit" method="post" action="tfwsedit.php">
         ...
         <div class="modal fade bs-modal-insert-lg" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <form class="form-horizontal" method="post" action="tfwsfeeInsert.php">
                     <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Semester</label>
                        <div class="col-sm-8">
                            <select class="form-control" id="sem" name="sem">
