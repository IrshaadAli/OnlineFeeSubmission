         ...
         <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <form class="form-horizontal" id="semedit" name="semedit" method="post" action="semedit.php">
         ...
         <div class="modal fade bs-modal-lg" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <form class="form-horizontal" method="post" action="semFee.php">
                     <div class="form-group">
         ...
         <div class="modal fade bs-modal-insert-lg" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <form class="form-horizontal" method="post" action="semfeeInsert.php">
                     <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Semester</label>
                        <div class="col-sm-8">
                            <select class="form-control" id="sem" name="sem">
