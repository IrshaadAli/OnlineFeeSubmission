        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
         ...
         <div id="bs-example-navbar-collapse-1"  class="collapse navbar-collapse hidden-lg hidden-md hidden-sm">
               <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="mainForm.php">Main Form Fee</a></li>
         ...
         <div class="row">
            ...
            <div class=" col-md-10 col-md-offset-2 main">
               ...
               <?php 
				...
				$result = mysqli_query($conn,"SELECT * FROM `mainform`");
                $data =array();
                $n = 0;
                ...
                ?>
                        <tr>
                           ...
                           <td><?php echo $data['mainFormFee']; ?> </td>
                          <td><button type="button" id="modalBtn<?php //echo ++$x; ?>" name="Btn<?php //echo ++$x; ?>" class="btn" data-toggle="modal" data-target=".bs-modal-lg">Edit</button></td>
                        </tr>
                        <?php } ?>
         ...
         <div class="modal fade bs-modal-lg" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <form class="form-horizontal" method="post" action="mainfee.php">
                  
                  		   
                     <div class="form-group">
                        <label for="inputPassword3" class="col-sm-3 control-label">Main Form Fee</label>
                        <div class="col-sm-8">
                           <input type="text" class="form-control" id="mainFormFee" name="mainFormFee" >
                        </div>
                     </div>
