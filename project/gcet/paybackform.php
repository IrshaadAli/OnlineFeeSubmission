...
<div class="container-fluid">
	<div class="row">
        ...
        <button type="button" class="btn btn-group-lg" data-toggle="modal" data-target=".bs-modal-lg" >Back Fee</button>
        </div>
        </div>
    <?php
		require_once('db_connect.php');
		 error_reporting(0);
	$enr = $_SESSION['enr'];
	 $qun = $_POST['subquantity']; 
	$formfee=mysqli_query($conn,"SELECT * FROM `backform` WHERE `subquantity`='$qun'");
                        ...
                        <td> <?php echo $sel['backFee']; ?> </td>
						 ...
						 <div>
                          <form action="transactionsSuccess.php" method="post">
                            ...
                            <input type="hidden" name="amount" value="<?php echo $sel['backFee']; ?>"> 
                            <input type="hidden" name="transactionType" value="Back Form Fee"> 
...
<div class="modal fade bs-modal-lg" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <form class="form-horizontal" method="post" action="paybackform.php">
                     <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Back Fee</label>
                        <div class="col-sm-8">
                            <select class="form-control" id="subquantity" name="subquantity">
                                 <option value=""> Number of Back </option>
                                 <option value="1">ONE</option>
                                 <option value="2">TWO</option>
                                 <option value="3">THREE OR MORE THAN THREE</option>
