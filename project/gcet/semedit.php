...
$batch =  $_POST['batch'];
 $id = $_POST['id'];
 $update ="UPDATE `semfee` SET `tuitionFee`='$tuitionFee',`developmentFee`='$developmentFee',`developmentFeeR`='$developmentFeeR',`cautionMoney`='$cautionMoney',`insuranceCharges`='$insuranceCharges',`total`='$total' WHERE `id`='$id' "; 
