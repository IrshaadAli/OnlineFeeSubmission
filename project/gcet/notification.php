      ...
      <div class="container-fluid">
         ...
         <div class="row">
            ...
            <div class=" col-md-10 col-md-offset-2 main">
               <h1 class="page-header">Notics</h1>
        ...
        $n=0;
                ...
                ?>
                        <tr>
                          ...
                          <td><button type="button" id="<?php echo $data['id']; ?> " name="Btn" class="btn editbtn " data-toggle="modal" data-target=".bs-example-modal-lg">Edit</button></td>
                        </tr>
                        <?php } ?>
        ...
        <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <form class="form-horizontal" id="notice" name="notice" method="post" action="noticeverify.php">             
                  	<div class="form-group">
                     <input type="hidden" name="val" id="hiddeninput" value=""/>
                        <label for="inputEmail3" class="col-sm-3 control-label">Verify</label>
                        <div class="col-sm-8">
         ...
         <div class="modal fade bs-modal-insert-lg" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <form class="form-horizontal" method="post" action="noticeInsert.php">
