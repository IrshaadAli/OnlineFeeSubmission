      ...
      <div class="container-fluid">
         ...
         <div id="bs-example-navbar-collapse-1"  class="collapse navbar-collapse hidden-lg hidden-md hidden-sm">
               <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="improvementForm.php">Improvement Form Fee</a></li>
               </ul>
         </div>
         ...
         <div class="row">
            ...
            <div class=" col-md-10 col-md-offset-2 main">
               ...
               <?php 
				...
				$result = mysqli_query($conn,"SELECT * FROM `improvementform`");
                $data =array();
				$x = 0;
			    $y=0;
			    ?>
                ...
                ?>
                        <tr>
                           ...
                           <td><?php echo $data['numofsub']; ?> </td>
                           <td><?php echo $data['impFee']; ?> </td>
                          <td><button type="button" id="<?php echo $data['id']; ?> ?>" name="Btn<?php echo ++$x; ?>" class="btn btn<?php echo ++$y; ?>" data-toggle="modal" data-target=".bs-modal-lg">Edit</button></td>
                        </tr>
                        <?php } ?>
                    ...
                    $(document).ready(function(){
                    	$('button').click(function(){
						  ...
						  if ($(this).hasClass('btn4')) {
                            $('#hiddeninput').attr('value','4')
                          };
						  if ($(this).hasClass('btn5')) {
                            $('#hiddeninput').attr('value','5')
                          };
						  if ($(this).hasClass('btn6')) {
                            $('#hiddeninput').attr('value','6')
                          };
                      })
                    })
                  </script>
                  </div>
                  <form class="form-horizontal" id="improvementform" name="improvementform" method="post" action="improvementfee.php">
                     <input type="hidden" name="id" id="hiddeninput" value/>
                     <div class="form-group">
                        <label for="inputPassword3" class="col-sm-3 control-label">Improvement Form Fee</label>
                        <div class="col-sm-8">
                           <input type="text" class="form-control" id="impFee" name="impFee" >
                        </div>
                     </div>
